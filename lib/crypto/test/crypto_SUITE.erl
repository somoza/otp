...
groups() ->
    [{non_fips, [], [
     ...
     {shake128,             [], [hash_xof]},
     {shake256,             [], [hash_xof]},
     {keccak256,            [], [hash, hmac, hmac_update]},
...
group_config(shake256 = Type, Config) ->
    ...
    [{hash_xof, {Type, Msgs, Digests, Lengths}} | Config];
group_config(keccak256 = Type, Config) ->
    {Msgs,Digests,Lengths} = sha3_keccak256_test_vectors(Type),
    [{hash_xof, {Type, Msgs, Digests, Lengths}} | Config];
...
sha3_keccak256_test_vectors(keccak256) ->
  {[%% KECCAK256 ShortMsg
    hexstr2bin(""),
    hexstr2bin("0f"),
    hexstr2bin("0dc1"),
